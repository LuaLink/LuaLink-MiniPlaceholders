...
public class LuaGetRelationalPlaceholders extends TwoArgFunction {
    @Override
    public LuaValue call(LuaValue lPlayer1, LuaValue lPlayer2) {
        ...
        return CoerceJavaToLua.coerce(MiniPlaceholders.getRelationalPlaceholders(player1, player2));
    }
}
